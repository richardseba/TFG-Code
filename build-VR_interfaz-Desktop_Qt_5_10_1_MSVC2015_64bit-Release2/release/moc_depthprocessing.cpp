...
#include "../../VR_interfaz/depthprocessing.h"
...
QT_MOC_LITERAL(4, 40, 20), // "frameProcessingEvent"
QT_MOC_LITERAL(5, 61, 10), // "startEvent"
QT_MOC_LITERAL(6, 72, 9) // "stopEvent"

    },
    "DepthProcessing\0startSignal\0\0stopSignal\0"
    "frameProcessingEvent\0startEvent\0"
    "stopEvent"
};
...
void DepthProcessing::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->frameProcessingEvent(); break;
        ...
        {
            typedef void (DepthProcessing::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DepthProcessing::startSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (DepthProcessing::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DepthProcessing::stopSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DepthProcessing::startSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void DepthProcessing::stopSignal()
{
