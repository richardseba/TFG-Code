...
public:
    ...
    void setupUi(QDialog *CalibDialog)
    {
        ...
        groupBox->setGeometry(QRect(20, 210, 291, 111));
        ...
        spinBox_squareSize->setGeometry(QRect(200, 50, 71, 41));
        spinBox_squareSize->setMinimum(1);
        spinBox_squareSize->setMaximum(999);
        label_3 = new QLabel(groupBox);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(200, 20, 111, 31));
        ...
        pushButton_calibrate->setGeometry(QRect(330, 270, 101, 41));
