...
QT_MOC_LITERAL(1, 15, 11), // "startSignal"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 10), // "stopSignal"
QT_MOC_LITERAL(4, 39, 16), // "frameUpdateEvent"
QT_MOC_LITERAL(5, 56, 10), // "startEvent"
QT_MOC_LITERAL(6, 67, 9) // "stopEvent"

    },
    "VRimageUpdater\0startSignal\0\0stopSignal\0"
    "frameUpdateEvent\0startEvent\0stopEvent"
};
...
void VRimageUpdater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->frameUpdateEvent(); break;
        ...
        {
            typedef void (VRimageUpdater::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VRimageUpdater::startSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (VRimageUpdater::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VRimageUpdater::stopSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void VRimageUpdater::startSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void VRimageUpdater::stopSignal()
{
