...
public:
    ...
    QPushButton *pushButton_distL;
    QLineEdit *lineEdit_distL;
    QGroupBox *groupBox_4;
    QLineEdit *lineEdit_matrixR;
    QPushButton *pushButton_matrixR;
    QPushButton *pushButton_distR;
    QLineEdit *lineEdit_distR;
    ...
    void setupUi(QDialog *LoadCalibParamsDialog)
    {
        ...
        LoadCalibParamsDialog->resize(400, 348);
        pushButton_load = new QPushButton(LoadCalibParamsDialog);
        pushButton_load->setObjectName(QStringLiteral("pushButton_load"));
        pushButton_load->setGeometry(QRect(191, 300, 75, 23));
        pushButton_cancel = new QPushButton(LoadCalibParamsDialog);
        pushButton_cancel->setObjectName(QStringLiteral("pushButton_cancel"));
        pushButton_cancel->setGeometry(QRect(283, 300, 75, 23));
        ...
        lineEdit_matrixL->setGeometry(QRect(20, 30, 200, 20));
        pushButton_matrixL = new QPushButton(groupBox_3);
        pushButton_matrixL->setObjectName(QStringLiteral("pushButton_matrixL"));
        pushButton_matrixL->setGeometry(QRect(230, 30, 90, 23));
        pushButton_distL = new QPushButton(groupBox_3);
        pushButton_distL->setObjectName(QStringLiteral("pushButton_distL"));
        pushButton_distL->setGeometry(QRect(230, 70, 90, 23));
        lineEdit_distL = new QLineEdit(groupBox_3);
        lineEdit_distL->setObjectName(QStringLiteral("lineEdit_distL"));
        lineEdit_distL->setGeometry(QRect(20, 70, 200, 20));
        groupBox_4 = new QGroupBox(LoadCalibParamsDialog);
        groupBox_4->setObjectName(QStringLiteral("groupBox_4"));
        groupBox_4->setGeometry(QRect(30, 170, 331, 111));
        lineEdit_matrixR = new QLineEdit(groupBox_4);
        lineEdit_matrixR->setObjectName(QStringLiteral("lineEdit_matrixR"));
        lineEdit_matrixR->setGeometry(QRect(20, 30, 200, 20));
        pushButton_matrixR = new QPushButton(groupBox_4);
        pushButton_matrixR->setObjectName(QStringLiteral("pushButton_matrixR"));
        pushButton_matrixR->setGeometry(QRect(230, 30, 90, 23));
        pushButton_distR = new QPushButton(groupBox_4);
        pushButton_distR->setObjectName(QStringLiteral("pushButton_distR"));
        pushButton_distR->setGeometry(QRect(230, 70, 90, 23));
        lineEdit_distR = new QLineEdit(groupBox_4);
        lineEdit_distR->setObjectName(QStringLiteral("lineEdit_distR"));
        lineEdit_distR->setGeometry(QRect(20, 70, 200, 20));
    ...
    void retranslateUi(QDialog *LoadCalibParamsDialog)
    {
        ...
        pushButton_matrixL->setText(QApplication::translate("LoadCalibParamsDialog", "Load Matrix", nullptr));
        pushButton_distL->setText(QApplication::translate("LoadCalibParamsDialog", "Load Distorsion", nullptr));
        groupBox_4->setTitle(QApplication::translate("LoadCalibParamsDialog", "Camera Right", nullptr));
        pushButton_matrixR->setText(QApplication::translate("LoadCalibParamsDialog", "Load Matrix", nullptr));
        pushButton_distR->setText(QApplication::translate("LoadCalibParamsDialog", "Load Distorsion", nullptr));
    } // retranslateUi
